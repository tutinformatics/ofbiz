...
link:docs/authentication.md[Authentication]

link:docs/deploy-to-heroku.md[Deploy]

link:docs/generic-rest-endpoint.md[REST]

link:docs/graphQL-endpoint.md[GraphQL]

link:docs/how-to-develop-docker.md[Docker]

link:docs/small-rest-example.md[REST example]

"Big data" docs: https://docs.google.com/document/d/1CkJA3Ad8scLUhbjYIMh656hjW-IeRNdmd1FUV7l1_Yc/edit?usp=sharing (Palju kasulikku infot)
