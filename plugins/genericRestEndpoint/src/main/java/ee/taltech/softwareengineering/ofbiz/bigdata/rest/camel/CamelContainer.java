 ...
 * under the License.
 *******************************************************************************/
package ee.taltech.softwareengineering.ofbiz.bigdata.rest.camel;
...
public class CamelContainer implements Container {
	...
	public void init(List<StartupCommand> ofbizCommands, String name, String configFile) throws ContainerException {
		...
		String packageName = ContainerConfig.getPropertyValue(cfg, "package", "ee.taltech.softwareengineering.ofbiz.bigdata.rest.camel.routes");
