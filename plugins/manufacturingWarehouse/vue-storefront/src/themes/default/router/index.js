...
const TestHome = () => import('theme/pages/HelloWorld.vue')
...
let routes = [
  ...
  { name: 'error', path: '/error', component: TestHome, meta: { layout: 'minimal' } },
  ...
  { name: 'manufacturing-warehouse', path: '/manufacturingwarehouse', component: TestHome },
